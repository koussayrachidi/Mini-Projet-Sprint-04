...
*/
@RequestMapping("/saveJeu")
public String saveProduit(@Valid JeuDTO jeu,
...
public String updateJeu(@ModelAttribute("jeu") JeuDTO jeu,
...
//conversion de la date
 ...
 List<JeuDTO> prods = jeuService.getAllJeux();
 modelMap.addAttribute("jeux", prods);
return "listeJeux";
}
